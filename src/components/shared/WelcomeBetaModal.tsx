  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) handleSkip(); }}>
      <DialogContent className="max-w-md">
        ...
        <div className="pt-3 border-t border-border mt-2 flex items-center justify-center gap-2 text-xs text-muted-foreground">
          ...
          <a href="https://discord.gg/HAQA8fACan" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground transition-colors">
